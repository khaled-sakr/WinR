...
const SearchBar = ({searchPage}) => {
  ...
  if(searchPage)
  return 
  <View className='relative flex-row mx-auto w-11/12 mt-6 '>
  ...
  <TouchableOpacity onPress={()=>{setValue('');router.replace('home')}} className='w-4/12 my-auto mx-2'>
    ...
    Cancel
      ...
      return <TouchableOpacity activeOpacity={0.9} onPress={()=>router.push(`/search/${2}`)} className='w-11/12 mt-6 mx-auto py-3 px-5 bg-[#DFDFDF] flex-col relative  h-[52px] rounded-3xl '>
