  ...
  return (
    <SafeAreaView>
       ...
       <View className='w-11/12 mx-auto flex-row justify-between h-[90px] mb-16'>
        <Image source={images.profileimage} className='w-[90px] rounded-full h-[90px]'/>
        <View className='w-[50%] my-auto'>
          <Text className='text-lg font-semibold text-slate-600'>Khaled sakr</Text>
          <Text className='font-semibold text-slate-600'>*****@gamil.com</Text>
        </View>
        <TouchableOpacity onPress={()=>router.push('edit')} className='w-[15%] flex-row rounded-lg text-center  bg-secondary h-6 my-auto'>
