    ...
    <SafeAreaView>
      <ScrollView>
        ...
        <View className="w-11/12 h-fit mt-6 flex-row flex justify-between mx-auto ">
          <TouchableOpacity
            className="w-[122.74px]"
            onPress={() => router.push("/men")}
          >
            <CustomIcon src={images.men} title="men" />
          </TouchableOpacity>
          <TouchableOpacity
            className="w-[122.74px]"
            onPress={() => router.push("/women")}
          >
            <CustomIcon src={images.women} title="women" />
          </TouchableOpacity>
          <TouchableOpacity
            className="w-[122.74px]"
            onPress={() => router.push("/children")}
          >
            <CustomIcon src={images.children} title="children" />
          </TouchableOpacity>
        </View>
        ...
        <BoldTitle
          title="Your Common Brands"
          addStyle="w-11/12 mt-8 mb-4 mx-auto text-secondary"
        />
        <View className="w-11/12 mx-auto flex-row justify-between ">
          <SquareText
            title="NIKE"
            addstyle="text-Font text-third bg-[#DFDFDF] h-[40px] w-[95px] rounded-[5px]"
          />
          <SquareText
            title="ZARA"
            addstyle="text-Font text-third bg-[#DFDFDF] h-[40px] w-[95px] rounded-[5px]"
        ...
        <Text className="mx-auto text-2xl font-bold mt-8 mb-2 w-11/12 text-secondary">
          Sells
        </Text>
        <View className="w-11/12 mx-auto bg-red-300 relative rounded-2xl mb-2">
          <Image source={images.sells} className="w-full" />
          <Text className="text-6xl font-semibold text-white absolute top-16 right-5">
            20% TO 70%
          </Text>
        </View>
      </ScrollView>
